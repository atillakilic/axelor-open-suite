...
import com.axelor.apps.hr.service.EmpSalaryServiceImpl;
import com.axelor.apps.hr.service.EmployeeHrService;
import com.axelor.apps.hr.service.EmployeeHrServiceImpl;
...
public class HumanResourceModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(EmpSalaryService.class).to(EmpSalaryServiceImpl.class);
    bind(EmployeeHrService.class).to(EmployeeHrServiceImpl.class);
  }
}
